...
Registry::Registry() {
        ...
        resourcePathToCachedUnit.insert(QStringLiteral("/TreeNode.qml"), &QmlCacheGeneratedCode::_0x5f__TreeNode_qml::unit);
        resourcePathToCachedUnit.insert(QStringLiteral("/Line.qml"), &QmlCacheGeneratedCode::_0x5f__Line_qml::unit);
